...
def davidson_response(A, b, hdiag, tol=1e-4, maxiter=100, verbose=False, guess=None):
...
def solve_ci(hvp, hdiag, roots, tol=1e-6, maxiter=100, verbose=False, c0=None, reference_state=None):
    """
