...
for operator, label in zip(integrals, labels):
    wfn_rsp, e_vecs_rsp, x_rsp, zpsi_rsp = resp(ham, nelec, wfn, e_vecs, operator, omega, gamma, couple_property=args.couple_property, couple_response=args.couple_response)
